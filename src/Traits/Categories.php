...
trait Categories
{
    ...
    public function createCategory(
        ...
        return $this->postRequest('/categories', [$params], $userName);
    }
     ...
     * @return array
     */
    public function getSubCategories($parentSlug): array
    {
        $response = $this->getRequest("/categories.json", ['parent_category_id' => 5]);
    ...
    {
        return $this->getRequest("/c/$categoryName.json");
    }
    ...
    {
        return $this->getRequest("/c/$id.json");
    }
    ...
    public function updateCategory(
        ...
        # This must PUT
        return $this->putRequest('/categories/' . $catid, [$params]);
    }
    ...
    {
        $response = $this->getRequest('/site.json');
    ...
    {
        return $this->deleteRequest("/categories/$id", [])->apiresult;
    }
}
